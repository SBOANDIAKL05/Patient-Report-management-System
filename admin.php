...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
          <a class="nav-link" href="admin.php?PageName=profile&id=<?php echo $_SESSION["User_ID"];?>">
...
<section id="sidebar"> 
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="./admin.php?PageName=adminDashboard">Dashboard</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin.php?PageName=user">Users</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin.php?PageName=viewPatient">Patients</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin.php?PageName=viewReports">Reports</a>
  </li>
  <!-- <li class="nav-item">
